  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Depot Operations Monitor</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          >
            ...
            {buses.map((bus, i) => (
              <option key={i} value={bus}>{bus}</option>
            ))}
          </select>
          ...
          <button onClick={handleAddEstimatedTiming} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Assign</button>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <button onClick={handleAddActualTrip} className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Log</button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <input type="date" value={selectedDate} onChange={e => setSelectedDate(e.target.value)} className="border p-2 rounded mb-4" />
                ...
                {filteredActual.map((trip, i) => {
                  ...
                  return (
                    <tr key={i}>
                      ...
                      <td className={`px-4 py-2 border ${getStatus(trip.busName) === 'Delayed' ? 'text-red-600' : getStatus(trip.busName) === 'Early' ? 'text-yellow-600' : 'text-green-600'}`}>
